...
(function attachEmployeeHubDatabase(global) {
  ...
  const RELEASE_VERSION = String(CONFIG.releaseVersion || '1.0.9');
  ...
  // Production v1.0.9: prevent duplicate submissions and skip writes when business data is unchanged.
